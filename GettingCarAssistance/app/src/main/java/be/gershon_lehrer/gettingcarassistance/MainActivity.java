...
public class MainActivity extends AppCompatActivity
    ...
    private void replaceFragmentContainerContent(Fragment fragment) {
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            replaceFragmentContainerContent(new WelcomeFragment());

        } else if (id == R.id.nav_gallery) {
            replaceFragmentContainerContent(new GarageFragment());
